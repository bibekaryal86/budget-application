  ...
  public ReportResponse readTransactionsSummary(
    ...
    return tx.execute(
        bs -> {
          ...
          List<ReportResponse.TransactionSummary> txnSummaries =
              dao.readTransactionSummary(requestParams.beginDate(), requestParams.endDate());

          return new ReportResponse(txnSummaries, ResponseMetadata.emptyResponseMetadata());
        });
  }
}
